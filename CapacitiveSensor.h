...
class CapacitiveSensor
{
  ...
  public:
  // methods
	CapacitiveSensor(uint8_t sendPin);
	void receivePin(uint8_t receivePin);
	long readRaw(uint8_t _receivePin, uint8_t samples);
	long read(uint8_t _receivePin, uint8_t samples);
